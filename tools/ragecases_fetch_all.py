...
MANIFEST = ROOT / "tools" / "manifest_all_146.json"
...
FALLBACK = [
    "sttrack", "rare", "epic", "legendary", "arcane",
...
def main() -> int:
    ...
    print(f"RAGECASES — FULL SKIN FETCH ({total} canonical images)")
